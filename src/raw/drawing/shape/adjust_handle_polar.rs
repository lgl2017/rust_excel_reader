...
pub struct AdjustHandlePolar {
    ...
    pub max_angle_adjustment: Option<AdjustAngle>,
                    ...
                    match a.key.local_name().as_ref() {
                        ...
                        b"maxAng" => {
                            polar.max_angle_adjustment =
                                Some(AdjustAngle::from_string(&string_value))
                        }
                        b"maxR" => {
